...
public export
0 LessThan : Bits32 -> Bits32 -> Type
LessThan m n = n < m

||| `From m n` is an alias for `n <= m`.
public export
0 To : Bits32 -> Bits32 -> Type
