...
public export
0 LessThan : Bits8 -> Bits8 -> Type
LessThan m n = n < m

||| `From m n` is an alias for `n <= m`.
public export
0 To : Bits8 -> Bits8 -> Type
